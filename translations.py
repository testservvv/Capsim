...
TR = {
    ...
    "help_mem_modes": {
        "en": "Number of axisymmetric Bessel modes J0(x_m·r/a) carried by "
              ...
              "free-PISTON mass sigma/S from above (1 mode 8/x_1² = "
              "1.383, 3 modes 1.138, 5 modes 1.083) and reaches it exactly "
              "for many modes — that is the exact limit of the modal "
              "series. NOTE: the ~7 kHz saddle is NOT a modal effect "
        ...
        "de": "Anzahl der axialsymmetrischen Bessel-Moden "
              ...
              "(1 Mode 8/x_1² = 1,383, 3 Moden 1,138, 5 Moden "
              "1,083) und erreicht sie bei vielen Moden exakt — "
    ...
    "help_center_post": {
        "en": "Diameter of a CENTER TERMINATION — a contact stud or bolt "
              ...
              "Everything downstream follows: mass factor, effective "
        ...
        "de": "Durchmesser einer MITTENTERMINIERUNG — Kontaktstift "
              ...
              "Massenfaktor, wirksame Fläche, Modenformen "
    ...
    "help_bias": {
        "en": "Voltage PER GAP, not the total supply. With two symmetric "
              ...
              "but only by about 1.354× (full solid electrode), not 2×: "
              "the gain comes solely from the static forces cancelling, so "
              "the membrane stays at rest instead of creeping to about "
              "0.45·gap as it does with one backplate. To model one supply "
              "split symmetrically instead "
        ...
        "de": "Spannung JE SPALT, nicht die Gesamtversorgung. Bei zwei "
              ...
              "aber nur um etwa den Faktor 1.354 (volle, lochfreie "
              "Elektrode), nicht 2: der Gewinn kommt allein daraus, dass "
              "sich die statischen Kräfte aufheben und die Membran im "
              "Ruhepunkt bleibt, statt wie bei einer Backplate bis auf etwa "
              "0.45·Spalt zu kriechen. Wer stattdessen "
    ...
    "help_body_len": {
        "en": "Axial length of the capsule body. The BEM contour is a "
              ...
              "Single-membrane capsules only, one or two symmetric "
              "backplates. A gradient capsule works too: its rear "
              "inlets get their own patch on the contour — a ring of "
              "holes in the side wall, or the rear end face for end "
              "holes (Gegenprobe 44). The depth is measured from the "
              "front face, which is the front sound inlet: with two "
              "backplates that is the outer face of the FRONT plate, so "
              "the depth is d_ext, gap + plate thickness more than to "
              "the membrane. Make the body LONGER than that, otherwise "
              "the ring is clamped to the rear face and you get a "
              "warning.",
        "de": "Axiale Länge des Kapselkörpers. Die BEM-Kontur ist ein "
              ...
              "Nur für Ein-Membran-Bauformen, mit einer oder zwei "
              "symmetrischen Backplates. Der Gradientenempfänger geht "
              "ebenfalls: seine rückwärtigen Einlässe bekommen einen "
              "eigenen Patch auf der Kontur — einen Bohrungskranz im "
              "Mantel, bei Endlöchern die hintere Stirnfläche "
              "(Gegenprobe 44). Gemessen wird ab der Stirnfläche, und "
              "die ist der vordere Schalleinlass: bei zwei Backplates "
              "also die Außenseite der VORDEREN Platte, die Tiefe ist "
              "damit d_ext — um Spalt + Plattendicke mehr als bis zur "
              "Membran. Den Körper LÄNGER wählen, sonst wird der Ring "
              "auf die Stirnfläche geklemmt und es gibt eine Warnung.",
    },
    "cap_bem_front": {
    ...
    "warn_bem_gradient": {
        "en": "**BEM with an open rear inlet.** The inlet is placed {wo} "
              "{d:.1f} mm behind the front sound inlet on the real "
              "contour — with two symmetric backplates that front inlet "
              "is the outer face of the FRONT plate, not the membrane. "
        ...
        "de": "**BEM mit offenem Rückeinlass.** Der Einlass sitzt {wo}, "
              "{d:.1f} mm hinter dem vorderen Schalleinlass auf der "
              "realen Kontur — bei zwei symmetrischen Backplates ist das "
              "die Außenseite der VORDEREN Platte, nicht die Membran. "
              "Sein Ringdruck trifft auf einer Kugelkontur "
    ...
    "help_grid_fine": {
        "en": "Resolution of the 3D solver's (r, φ) grid. Off = COARSE "
              "(default, fast): hole mouths are only about one cell per "
              "radius wide. The mouth edges follow the true circular "
              "outline (self-test, check 51), so in the test capsules the "
              "level usually lies within ~0.2 dB of finer grids; where "
              "mouths are smaller than a cell (e.g. 12 small holes on "
              "the 96-cell ring) up to ~0.5 dB, the 180° rejection up to "
              "~1 dB. On = FINE: every hole mouth gets at least 2 cells "
              "per radius, radially and azimuthally, and both directions "
              "are at least 1.5× finer than coarse — remainder ~0.1 dB. "
              "Meant as a reference run for the final design, with few "
              "frequency points. Only active with the 3D field model.",
        "de": "Auflösung des (r, φ)-Gitters des 3D-Lösers. Aus = GROB "
              "(Standard, schnell): Lochmündungen sind nur etwa eine "
              "Zelle je Radius breit. Ihre Ränder folgen der wahren "
              "Kreiskontur (Selbsttest, Gegenprobe 51), an den "
              "Prüfkapseln liegt der Pegel damit meist auf ~0,2 dB bei "
              "feineren Gittern; wo Mündungen kleiner als eine Zelle "
              "sind (z. B. 12 kleine Löcher auf dem 96er-Raster), bis "
              "~0,5 dB, die 180°-Dämpfung bis ~1 dB. Ein = FEIN: jede "
              "Lochmündung bekommt mindestens 2 Zellen je Radius, radial "
              "wie azimutal, und beide Richtungen sind mindestens 1,5-mal "
              "feiner als grob — Rest ~0,1 dB. Als Referenzrechnung für "
              "den Endstand gedacht, mit wenigen Frequenzpunkten. Nur mit "
              "dem 3D-Feldmodell wirksam.",
    },
    "cap_grid_fine": {
